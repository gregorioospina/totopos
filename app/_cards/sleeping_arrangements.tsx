		...
		<div className="flex flex-col gap-y-4 px-6 py-6 md:py-10">
			...
			<div className="flex flex-col gap-y-3">
				...
				<div className="flex flex-col gap-y-1">
					{" "}
					<div className="flex justify-between">
						<p className="h3 font-bold">Hotel Sonesta</p>{" "}
						<a className="" target="__blank" href="https://www.sonestapereira.com/">
							Ir a hotel Sonesta
						</a>
					</div>
					<p className="body">Se encuentra a 5min en carro del lugar del matrimonio.</p>
				...
				<div className="flex flex-col gap-y-1">
					<div className="flex justify-between">
						<p className="h3 font-bold">Apartamentos Cerritos Mall</p>
