...
const DressCode = (props: IDressCode) => {
	return (
		<div className="flex flex-col gap-y-4 px-6 py-6 md:py-10">
			...
			<p className="body">
				Vestido largo / traje y corbata. Puede ser del color o estilo que prefieran. El evento será al aire libre y el terreno es irregular, por lo que
				recomendamos a las mujeres usar zapatos de plataforma o tacón ancho para mayor comodidad.
			</p>
